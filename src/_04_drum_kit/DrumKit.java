...
public class DrumKit implements MouseListener {
	...
	public void run() throws MalformedURLException {
		...
		// 1. Make a JFrame variable and initialize it using 
		JFrame rit = new JFrame();

		// 2. Make the frame visible and
		// set its default close operation to 
		rit.setVisible(true);
		
		rit.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		// 3. Set the size of the frame
rit.setSize(310,429);
		// 4. Set the title of the frame
rit.setTitle("Drumkit");
		// 5. Make a JPanel variable and initialize it using "new JPanel().
JPanel r3t = new JPanel();
...
String DRUy62v = "DRUy6.jpg";
		// 9. Edit the next line to use your String variable
		
drumLabelWithImage = createLabelImage(DRUy62v);

		// 10. Add the image to the panel
r3t.add(drumLabelWithImage);
		// 11. Set the layout of the panel to "new 
